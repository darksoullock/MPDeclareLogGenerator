...
public class Evaluator {
    ...
    private static AlloyRunConfiguration debugConf() {
        ...
        conf.minLength = 2;
        conf.maxLength = 10;
        //conf.nPositiveTraces = 100;
        conf.nNegativeVacuousTraces = 10;
        conf.inFilename = "./data/test.decl";
        //conf.inFilename = "./data/loanApplication.decl";
        conf.shuffleConstraintsIterations = 0;
    ...
    public static void main(String[] args) throws Exception {
        ...
        XLog plog = getLog(
                ...
                config.shuffleConstraintsIterations,
    ...
    private static void saveSmv(AlloyRunConfiguration config) throws GenerationException, DeclareParserException {
        DeclareModel model = new DeclareParser(1).Parse(IOHelper.readAllText(config.inFilename));
        SmvCodeGenerator a = new SmvCodeGenerator();
        a.run(model, config.minLength);
