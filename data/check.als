...
one sig TE0 extends TaskEvent {} {pos=-16 task=ApplyForTrip}
one sig TE1 extends TaskEvent {} {pos=-15 task=BookMeansOfTransport}
one sig TE2 extends TaskEvent {} {pos=-14 task=BookAccomodation}
one sig TE3 extends TaskEvent {} {pos=-13 task=ArchiveDocuments}
